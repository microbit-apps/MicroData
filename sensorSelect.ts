namespace microdata {
  ...
  import AppInterface = user_interface_base.AppInterface
    ...
    */
    ...
    const TUTORIAL_TEXT_TOP_ALIGNMENT = -54;
    ...
    export class SensorSelect extends CursorScene {
        ...
        private tutorialTextYOffset: number = TUTORIAL_TEXT_BOT_ALIGNMENT;

        constructor(app: AppInterface, nextSceneEnum: MicroDataSceneEnum) {
        ...
        /* override */ startup() {
            ...
            this.btns[3].push(new Button({
                ...
                onClick: () => {
                    ...
                    this.app.popScene()
                    if (this.nextSceneEnum === MicroDataSceneEnum.LiveDataViewer) {
                        this.app.pushScene(new LiveDataViewer(this.app, sensors))
                    }

                    else if (this.nextSceneEnum === MicroDataSceneEnum.RecordingConfigSelect)
                        this.app.pushScene(new RecordingConfigSelection(this.app, sensors))

                    else if (this.nextSceneEnum === MicroDataSceneEnum.DistributedLogging)
                        this.app.pushScene(new RecordingConfigSelection(this.app, sensors, MicroDataSceneEnum.DistributedLogging))
                }
            }))
            ...
            context.onEvent(
                ...
                () => {
                    if (this.navigator.getRow() == 0) {
                        this.tutorialTextYOffset = TUTORIAL_TEXT_TOP_ALIGNMENT;
                    }

                    if (this.navigator.getRow() == 1) {
                        this.tutorialTextYOffset = TUTORIAL_TEXT_BOT_ALIGNMENT
                    }
                    ...
                    if (this.userHasPressedABtn && this.tutorialHintIndex <= 1) {
                        ...
                        this.tutorialHintIndex = 1
                    this.moveCursor(user_interface_base.CursorDir.Up)
                }
            )
            ...
            context.onEvent(
                ...
                () => {
                    ...
                    if (this.userHasPressedABtn && this.tutorialHintIndex <= 1) {
                        ...
                        this.tutorialHintIndex = 1
                    this.moveCursor(user_interface_base.CursorDir.Down)
                }
            )
            context.onEvent(
                ControllerButtonEvent.Pressed,
